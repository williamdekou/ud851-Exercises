...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        mBinding.flight.textViewOriginAirport.setText(info.originCode);
        mBinding.flight.textViewFlightCode.setText(info.flightCode);
        mBinding.flight.textViewDestinationAirport.setText(info.destCode);
