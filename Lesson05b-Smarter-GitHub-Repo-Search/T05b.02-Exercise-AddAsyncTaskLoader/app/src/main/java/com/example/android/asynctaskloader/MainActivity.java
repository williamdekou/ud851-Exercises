...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    private void makeGithubSearchQuery() {
        ...
        if (githubQuery == null || githubQuery.isEmpty()){
            mSearchBoxEditText.setHint("There is nothing to search for");
        }
        ...
        Bundle queryBundle = new Bundle(getClassLoader());
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                try {
                    ...
                    try {
                        githubSearchResults = NetworkUtils.getResponseFromHttpUrl(new URL(githubUrl));
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
