    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra(EXTRA_TASK_ID)) {
            ...
            if (mTaskId == DEFAULT_TASK_ID) {
                ...
                AddTaskViewModelFactory vf = new AddTaskViewModelFactory(mDb, mTaskId);
                final LiveData<TaskEntry> task = ViewModelProviders.of(this, vf).get(AddTaskViewModel.class).getTask();
