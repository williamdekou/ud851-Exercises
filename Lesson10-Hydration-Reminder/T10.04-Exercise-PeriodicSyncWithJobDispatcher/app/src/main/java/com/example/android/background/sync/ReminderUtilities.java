...
public class ReminderUtilities {
    ...
    public static final int REMINDER_INTERVAL_SECONDS = (int) TimeUnit.SECONDS.toSeconds(REMINDER_INTERVAL_MINUTES);
    ...
    public static synchronized void scheduleChargingReminder(Context context) {
        ...
        GooglePlayDriver gpl = new GooglePlayDriver(context);
            // COMPLETED (19) Create a new FirebaseJobDispatcher with the driver
        FirebaseJobDispatcher dispatcher = new FirebaseJobDispatcher(gpl);
