...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PEDDING_INTENT_ID = 12012;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 478569;
    ...
    //      TODO (6) Create an Intent to launch WaterReminderIntentService
        Intent ignoreNotificationReminderIntent = new Intent(context, WaterReminderIntentService.class);
    //      TODO (7) Set the action of the intent to designate you want to dismiss the notification
        ignoreNotificationReminderIntent.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);
    //      TODO (8) Create a PendingIntent from the intent to launch WaterReminderIntentService
        PendingIntent pendingIntent = PendingIntent.getService(
                context,
                ACTION_IGNORE_PEDDING_INTENT_ID,
                ignoreNotificationReminderIntent,
    ...
    //      TODO (12) Create an Intent to launch WaterReminderIntentService
        Intent launchWRIntent = new Intent(context, WaterReminderIntentService.class);
    //      TODO (13) Set the action of the intent to designate you want to increment the water count
        launchWRIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
